 ...
 *   + Upgraded the spawn item tab to contain multiple items and all their recipes
 */
    ...
    internal class BossLogPanel : UIElement
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (BossLogUI.PageNum == -1)
            {
                ...
                {
                    Color maskedHead;
                    if (BossAssist.instance.setup.SortedBosses[headNum].downed()) maskedHead = Color.White;
                    else maskedHead = Color.Black;
            ...
            if (Id == "PageOne" && BossLogUI.PageNum >= 0)
            {
                ...
                Color masked;
                if (shortcut.downed()) masked = Color.White;
                else masked = Color.Black;
    ...
    internal class TableOfContents : UIText
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
			...
			if (order != -1f)
            {
				...
				{
					if (IsMouseHovering) TextColor = Color.Gold;
					else TextColor = Color.Khaki;
				}
